...
function displayPriceInCorner(productCode)
{
    ...
    if (priceElement && productCode) {
        ...
        chrome.storage.sync.get(['products'], function (result)
        {
            ...
            <h4 style="color: #CB0000; font-family: Niramit, Arial, sans-serif;"><span style="
                    color: #CB0000;
                    font-size: 20px;
                    font-weight: 600;
          ...
          <tr style="color: #C00000; font-family: Montserrat, Arial, sans-serif;font-size: 20px;font-weight: 700;">
...
{
    locationInfo.id = 'amazonLocationInfo';
    locationInfo.innerHTML = '<img width="120" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEibV0Hd-3btcwA8nOaDdZYJBdviptqN3nWDdeGRYWqbHgbWFkxZ2jH0tPhsyxw8jRjCcDqyEaYQRBUrTmNczR8GuE7T1re6v4xEvWGARshPzyYg9tMSMYg0y9jUwaxR4q-nlBTxuj5OgRk8c5gNDXPvU6br6Rcv7Oqq9Qt0v2EMOC6e4_CzwPyGnFUoh_0/s320/logo.png" alt="img" />'
    locationInfo.style.cssText = `
                position: fixed;
                bottom: 40px;
                left: 10px;
