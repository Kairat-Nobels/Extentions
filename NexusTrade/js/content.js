...
function displayPriceInCorner(productCode)
{
    ...
    if (priceElement && productCode) {
        ...
        chrome.storage.sync.get(['products'], function (result)
        {
            ...
            <h4 style="color: #CB0000; font-family:  Arial, sans-serif;"><span style="
                    color: #CB0000;
                    font-size: 20px;
                    font-weight: 600;
...
{
    locationInfo.id = 'amazonLocationInfo';
    locationInfo.innerHTML = '<img width="120" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjShXI4dvAw5KAQB5olmml5Vvd0T6HMgXfWnFHCRpMKdSKZIbAygP8495wlbaMFsrMogxtJRON-wEIlWgKaEjH3ZhigZr-43V6FTR2AeNvsgboN5wplsQFTvAgW_B7eCbs0K6y4AWFuDClHbGRKcJIewdzcPVSin12oyG8KKvuYZYxgBu4f5AYvIrDmWBs/s320/logo.png" alt="img" />'
    locationInfo.style.cssText = `
                position: fixed;
                bottom: 40px;
                left: 10px;
