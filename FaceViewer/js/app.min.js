(() => {
        ...
        (e = s.nmd(e)),
          function (e, t, i) {
            ...
            var n = function (e, t, s) {
                s = r.extend({}, r.options, s);
                var i = r.runValidations(e, t, s);
                if (
                  i.some(function (e) {
                    return r.isPromise(e.error);
                  })
                )
                  throw new Error(
                    "Use validate.async if you want support for promises"
                  );
                return n.processValidationResults(i, s);
              },
              r = n;
            (r.extend = function (e) {
              return (
              ...
              r.extend(n, {
                version: {
                  ...
                  metadata: null,
                  toString: function () {
                    var e = r.format("%{major}.%{minor}.%{patch}", r.version);
                    return (
                      r.isEmpty(r.version.metadata) ||
                        (e += "+" + r.version.metadata),
                      e
                    );
                  },
                },
                ...
                runValidations: function (e, t, s) {
                  ...
                  for (i in ((r.isDomElement(e) || r.isJqueryElement(e)) &&
                    (e = r.collectFormValues(e)),
                  t))
                    for (n in ((o = r.getDeepObjectValue(e, i)),
                    (a = r.result(t[i], o, e, i, s, t)))) {
                      if (!(l = r.validators[n]))
                        throw (
                          ((c = r.format("Unknown validator %{name}", {
                            name: n,
                          })),
                          new Error(c))
                        );
                      (d = a[n]),
                        (d = r.result(d, o, e, i, s, t)) &&
                          u.push({
                            attribute: i,
                            value: o,
                            validator: n,
                            ...
                            attributes: e,
                            options: d,
                            error: l.call(l, o, d, i, e, s),
                          });
                    }
                  return u;
                },
                processValidationResults: function (e, t) {
                  (e = r.pruneEmptyErrors(e, t)),
                    (e = r.expandMultipleErrors(e, t)),
                    (e = r.convertErrorMessages(e, t));
                  var s = t.format || "grouped";
                  if ("function" != typeof r.formatters[s])
                    throw new Error(r.format("Unknown format %{format}", t));
                  return (e = r.formatters[s](e)), r.isEmpty(e) ? void 0 : e;
                },
                async: function (e, t, s) {
                  var i =
                    (s = r.extend({}, r.async.options, s)).wrapErrors ||
                    function (e) {
                      return e;
                    };
                  !1 !== s.cleanAttributes && (e = r.cleanAttributes(e, t));
                  var n = r.runValidations(e, t, s);
                  return new r.Promise(function (o, a) {
                    r.waitForResults(n).then(
                      function () {
                        var l = r.processValidationResults(n, s);
                        l ? a(new i(l, s, e, t)) : o(e);
                      },
                      function (e) {
                        a(e);
                      }
                ...
                single: function (e, t, s) {
                  return (
                    (s = r.extend({}, r.single.options, s, {
                      format: "flat",
                      fullMessages: !1,
                    })),
                    r(
                ...
                isJqueryElement: function (e) {
                  return e && r.isString(e.jquery);
                },
                isDomElement: function (e) {
                  return (
                    !!e &&
                    !(!e.querySelectorAll || !e.querySelector) &&
                    (!(!r.isObject(document) || e !== document) ||
                ...
                isEmpty: function (e) {
                  var t;
                  if (!r.isDefined(e)) return !0;
                  if (r.isFunction(e)) return !1;
                  if (r.isString(e)) return r.EMPTY_STRING_REGEXP.test(e);
                  if (r.isArray(e)) return 0 === e.length;
                  if (r.isDate(e)) return !1;
                  if (r.isObject(e)) {
                    for (t in e) return !1;
                    return !0;
                  }
                ...
                format: r.extend(
                  function (e, t) {
                    return r.isString(e)
                      ? e.replace(r.format.FORMAT_REGEXP, function (e, s, i) {
                          return "%" === s ? "%{" + i + "}" : String(t[i]);
                        })
                      : e;
                  },
                  {
                ...
                prettify: function (e) {
                  return r.isNumber(e)
                    ...
                    : (e = "" + e)
                        ...
                        .replace(/\\+/g, "")
                        .replace(/[_-]/g, " ")
                        .replace(/([a-z])([A-Z])/g, function (e, t, s) {
                          return t + " " + s.toLowerCase();
                        })
                        .toLowerCase();
                },
                stringifyValue: function (e, t) {
                  return ((t && t.prettify) || r.prettify)(e);
                },
                isString: function (e) {
                ...
                isHash: function (e) {
                  return r.isObject(e) && !r.isArray(e) && !r.isFunction(e);
                },
                contains: function (e, t) {
                  return (
                    !!r.isDefined(e) &&
                    (r.isArray(e) ? -1 !== e.indexOf(t) : t in e)
                  );
                },
                unique: function (e) {
                  return r.isArray(e)
                    ? e.filter(function (e, t, s) {
                        return s.indexOf(e) == t;
                      })
                    : e;
                },
                forEachKeyInKeypath: function (e, t, s) {
                  if (r.isString(t)) {
                    var i,
                      n = "",
                      o = !1;
                ...
                getDeepObjectValue: function (e, t) {
                  if (r.isObject(e))
                    return r.forEachKeyInKeypath(e, t, function (e, t) {
                      if (r.isObject(e)) return e[t];
                    });
                },
                collectFormValues: function (e, t) {
                  var s,
                    ...
                    l,
                    d = {};
                  if ((r.isJqueryElement(e) && (e = e[0]), !e)) return d;
                  for (
                    t = t || {},
                    ...
                    if (
                      ((n = o.item(s)),
                      !r.isDefined(n.getAttribute("data-ignored")))
                    ) {
                      var c = n.name.replace(/\./g, "\\\\.");
                      (l = r.sanitizeFormValue(n.value, t)),
                        "number" === n.type
                          ? (l = l ? +l : null)
                          : "checkbox" === n.type
                          ? n.attributes.value
                            ? n.checked || (l = d[c] || null)
                            : (l = n.checked)
                          : "radio" === n.type &&
                            (n.checked || (l = d[c] || null)),
                        (d[c] = l);
                  ...
                  for (
                    o = e.querySelectorAll("select[name]"), s = 0;
                    s < o.length;
                    ++s
                  )
                    if (
                      ...
                      if (n.multiple)
                        for (i in ((l = []), n.options))
                          (a = n.options[i]) &&
                            a.selected &&
                            l.push(r.sanitizeFormValue(a.value, t));
                      else {
                        var u =
                          void 0 !== n.options[n.selectedIndex]
                            ? n.options[n.selectedIndex].value
                            : "";
                        l = r.sanitizeFormValue(u, t);
                      }
                      d[n.name] = l;
                    }
                  return d;
                ...
                sanitizeFormValue: function (e, t) {
                  return (
                    t.trim && r.isString(e) && (e = e.trim()),
                    !1 !== t.nullify && "" === e ? null : e
                  );
                },
                capitalize: function (e) {
                  return r.isString(e) ? e[0].toUpperCase() + e.slice(1) : e;
                },
                pruneEmptyErrors: function (e) {
                  return e.filter(function (e) {
                    return !r.isEmpty(e.error);
                  });
                },
                    ...
                    e.forEach(function (e) {
                      ...
                      r.isString(n)
                        ? ("^" === n[0]
                            ? (n = n.slice(1))
                            : !1 !== t.fullMessages &&
                              (n = r.capitalize(i(e.attribute)) + " " + n),
                          (n = n.replace(/\\\^/g, "^")),
                          (n = r.format(n, {
                            value: r.stringifyValue(e.value, t),
                          })),
                          s.push(
                            r.extend({}, e, {
                              error: n,
                ...
                cleanAttributes: function (e, t) {
                  function s(e, t, s) {
                    return r.isObject(e[t]) ? e[t] : (e[t] = !!s || {});
                  }
                  return r.isObject(t) && r.isObject(e)
                    ? (function e(t, s) {
                        ...
                        (t = (function (e) {
                          var t,
                            i = {};
                          for (t in e) e[t] && r.forEachKeyInKeypath(i, t, s);
                          return i;
                        })(t))
                      )
                    : {};
                },
                exposeModule: function (e, t, s, i, n) {
                  s
                    ? (i && i.exports && (s = i.exports = e), (s.validate = e))
                    : ((t.validate = e),
                      e.isFunction(n) &&
                        n.amd &&
                        n([], function () {
              ...
              (n.validators = {
                presence: function (e, t) {
                  if (
                    !1 !== (t = r.extend({}, this.options, t)).allowEmpty
                      ? !r.isDefined(e)
                      : r.isEmpty(e)
                  )
                    return t.message || this.message || "can't be blank";
                },
                length: function (e, t, s) {
                  if (r.isDefined(e)) {
                    var i,
                      n = (t = r.extend({}, this.options, t)).is,
                      o = t.maximum,
                      a = t.minimum,
                      l = [],
                      d = (e = (
                    ...
                    return r.isNumber(d)
                      ? (r.isNumber(n) &&
                        ...
                        l.length > 0 ? t.message || l : void 0)
                      : t.message || this.notValid || "has an incorrect length";
                  }
                },
                numericality: function (e, t, s, i, n) {
                  if (r.isDefined(e)) {
                    var o,
                      a,
                      l = [],
                      ...
                      c =
                        (t = r.extend({}, this.options, t)).prettify ||
                        (n && n.prettify) ||
                        r.prettify;
                    if (r.isString(e) && t.strict) {
                      var u = "^-?(0|[1-9]\\d*)";
                      if (
                        (t.onlyInteger || (u += "(\\.\\d+)?"),
                        (u += "$"),
                    ...
                    if (t.onlyInteger && !r.isInteger(e))
                      return (
                        t.message ||
                        t.notInteger ||
                        this.notInteger ||
                ...
                datetime: r.extend(
                  function (e, t) {
                    if (!r.isFunction(this.parse) || !r.isFunction(this.format))
                      throw new Error(
                    ...
                    if (r.isDefined(e)) {
                      var s,
                        i = [],
                        n = (t = r.extend({}, this.options, t)).earliest
                ...
                date: function (e, t) {
                  return (
                    ...
                    r.validators.datetime.call(r.validators.datetime, e, t)
                  );
                },
                format: function (e, t) {
                  (r.isString(t) || t instanceof RegExp) &&
                    (t = {
                      pattern: t,
                    });
                  var s,
                    i =
                      (t = r.extend({}, this.options, t)).message ||
                      this.message ||
                      "is invalid",
                    n = t.pattern;
                  if (r.isDefined(e))
                    return r.isString(e)
                      ? (r.isString(n) && (n = new RegExp(t.pattern, t.flags)),
                        (s = n.exec(e)) && s[0].length == e.length ? void 0 : i)
                      : i;
                },
                ...
                exclusion: function (e, t) {
                  if (
                    ...
                    var s =
                      t.message || this.message || "^%{value} is restricted";
                    return (
                      r.isString(t.within[e]) && (e = t.within[e]),
                      r.format(s, {
                        value: e,
                      })
                    );
                ...
                email: r.extend(
                  function (e, t) {
                    ...
                    if (r.isDefined(e))
                      return r.isString(e) && this.PATTERN.exec(e) ? void 0 : s;
                  },
                  {
                    PATTERN:
                ...
                equality: function (e, t, s, i, n) {
                  if (r.isDefined(e)) {
                    ...
                    if (r.isEmpty(t.attribute) || !r.isString(t.attribute))
                      throw new Error(
                        "The attribute must be a non empty string"
                      );
                    var a = r.getDeepObjectValue(i, t.attribute),
                      l =
                        t.comparator ||
                        function (e, t) {
                          return e === t;
                        },
                      d = t.prettify || (n && n.prettify) || r.prettify;
                    return l(e, a, t, s, i)
                      ? void 0
                      : r.format(o, {
                          attribute: d(t.attribute),
                        });
                  }
                },
                url: function (e, t) {
                  if (r.isDefined(e)) {
                    var s =
                      ...
                      n = t.allowLocal || this.allowLocal || !1,
                      o = t.allowDataUrl || this.allowDataUrl || !1;
                    if (!r.isString(e)) return s;
                    var a =
                        "^(?:(?:" +
                        i.join("|") +
                        ")://)(?:\\S+(?::\\S*)?@)?(?:",
                    ...
                    return (
                      ...
                      new RegExp(a, "i").exec(e) ? void 0 : s
                    );
                  }
                },
                type: r.extend(
                  function (e, t, s, i, n) {
                    if (
                      ...
                      var o,
                        a = r.extend({}, this.options, t),
                        l = a.type;
                      if (!r.isDefined(l))
                        throw new Error("No type was specified");
                      if (
                        ((o = r.isFunction(l) ? l : this.types[l]),
                        !r.isFunction(o))
                      )
                        throw new Error(
                      ...
                      if (!o(e, a, s, i, n)) {
                        ...
                        return (
                          r.isFunction(d) && (d = d(e, t, s, i, n)),
                          r.format(d, {
                            attribute: r.prettify(s),
                            type: l,
                          })
                        );
                      }
                  ...
                  },
                  {
                    types: {
                      object: function (e) {
                        return r.isObject(e) && !r.isArray(e);
                      },
                      array: r.isArray,
                      integer: r.isInteger,
                      number: r.isNumber,
              ...
              (n.formatters = {
                ...
                grouped: function (e) {
                  var t;
                  for (t in (e = r.groupErrorsByAttribute(e)))
                    e[t] = r.flattenErrorsToArray(e[t]);
                  return e;
                },
              ...
              n.exposeModule(n, this, e, t, s.amdD);
          }.call(this, t, e, s.amdD);
      },
    },
    t = {};
  ...
  function s(i) {
    ...
    return e[i].call(r.exports, r, r.exports, s), (r.loaded = !0), r.exports;
  }
  (s.amdD = function () {
    ...
    (() => {
      "use strict";
      var e = s(765);
      const t = document.getElementById("fv4-guests-btn"),
        i = document.getElementById("fv4-admirers-btn"),
        n = document.getElementById("fv4-invisible-btn"),
        r = document.getElementById("fv4-stats-btn"),
        o = document.getElementById("fv4-my-account-btn"),
        a = document.getElementById("fv4-settings-btn0"),
        l = document.getElementById("fv4-settings-btn"),
        d = document.getElementById("fv4-logout"),
        c = document.getElementById("fv4-change-acc"),
        u = document.querySelector(".fv4__contentBlock.guests-block"),
        p = document.querySelector(".fv4__contentBlock.admirers-block"),
        f = document.querySelector(".fv4__contentBlock.invisible-block"),
        m = document.getElementById("fv4"),
        g = document.querySelector(".fv4__logo"),
        v = document.querySelector(".fv4__body-title"),
        w = document.querySelectorAll(".fv4__menu-list-btn"),
        b = document.querySelectorAll(".fv4__contentBlock"),
        S = document.querySelectorAll(".fv4-demo-btn"),
        y = document.querySelector(".login-form__passv-toggle"),
        ...
        return function (...t) {
          if (void 0 === t[0]) {
            for (let t = 0; t < this.length; t += 1)
              I.indexOf(e) < 0 &&
                (e in this[t] ? this[t][e]() : $(this[t]).trigger(e));
            return this;
          }
          return this.on(e, ...t);
        };
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
              ...
              void 0 !== n &&
                ...
                (B(t[i]) && B(r[i])
                  ...
                  : !B(t[i]) && B(r[i])
                  ? ((t[i] = {}),
                    r[i].__swiper__ ? (t[i] = r[i]) : j(t[i], r[i]))
                  : (t[i] = r[i]));
            }
          }
        }
        ...
        X = {
          ...
          updateSlides: function () {
            ...
            if (
              ...
              F(e.wrapperEl, "--swiper-centered-offset-before", -p[0] + "px"),
                F(
                  e.wrapperEl,
      ...
      function J(e) {
        ...
        c && l.target && l.target.shadowRoot && u && (d = N(u[0]));
        ...
        if (
          ...
          d.is(n.focusableElements) &&
            ...
            s.activeElement &&
              N(s.activeElement).is(n.focusableElements) &&
              s.activeElement !== d[0] &&
      ...
      function Z(e) {
        ...
        if (!s.allowTouchMove)
          return (
            N(l.target).is(i.focusableElements) || (s.allowClick = !1),
            void (
              i.isTouched &&
              (Object.assign(r, {
                startX: c,
      ...
      const ue = {
          ...
          loop: {
            loopCreate: function () {
              const e = this,
                ...
                n = i.children().length > 0 ? N(i.children()[0].parentNode) : i;
              ...
              if (s.loopFillGroupWithBlank) {
                ...
                if (e !== s.slidesPerGroup) {
                  for (let i = 0; i < e; i += 1) {
                    const e = N(t.createElement("div")).addClass(
              ...
              for (let e = 0; e < a.length; e += 1)
                n.append(N(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
              for (let e = o.length - 1; e >= 0; e -= 1)
                n.prepend(
                  N(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass)
                );
            },
            loopFix: function () {
              const e = this;
          ...
          breakpoints: {
            setBreakpoint: function () {
              ...
              p && s && e.changeDirection(), j(e.params, l);
          ...
          images: {
            loadImage: function (e, t, s, i, n, r) {
              ...
              N(e).parent("picture")[0] || (e.complete && n)
                ? l()
                : t
                ? ((a = new o.Image()),
                  (a.onload = l),
      ...
      class fe {
        ...
        mount(e) {
          ...
          let n = (() => {
            ...
            return s.children ? s.children(i()) : N(s).children(i());
          })();
      ...
      Object.keys(ue).forEach((e) => {
        ...
        (() => {
          function e(e) {
            b.forEach((e) => {
              e.classList.contains("-act-block-") &&
                e.classList.remove("-act-block-");
            }),
              m.classList.contains("-account-") &&
                m.classList.remove("-account-"),
              m.classList.contains("-settings-") &&
                m.classList.remove("-settings-"),
              e.classList.add("-act-block-");
          }

          function s(e) {
            w.forEach((e) => {
              e.classList.contains("-act-btn-") &&
                e.classList.remove("-act-btn-");
            }),
              e.classList.add("-act-btn-");
          }

          // m.classList.add("-start-"), s(l), v.innerHTML = "start"

          g.addEventListener("click", (i) => {
            e(u), s(t), (v.innerHTML = "GUESTS");
          }),
            t.addEventListener("click", (i) => {
              e(u), s(t), (v.innerHTML = "GUESTS");
            }),
            i.addEventListener("click", (t) => {
              e(p), s(i), (v.innerHTML = "fans");
            }),
            n.addEventListener("click", (t) => {
              e(f), s(n), (v.innerHTML = "invisible mode");
            }),
            // o.addEventListener("click", (e => {
            //     m.classList.contains("-settings-") && m.classList.remove("-settings-");
            ...
            l.addEventListener("click", (e) => {
              m.classList.contains("-account-") &&
                m.classList.remove("-account-"),
                m.classList.add("-settings-"),
                s(l),
                (v.innerHTML = "settings");
            }),
            // a.addEventListener("click", (e => {
            //     m.classList.contains("-account-") && m.classList.remove("-account-"), m.classList.add("-settings-"), s(l), v.innerHTML = "settings"
            // })),
            ...
            //     m.classList.remove("-account-"), m.classList.add("-start-")
            // })),
            S.forEach((i) => {
        ...
        new (class {
          constructor(e, t = !1, s) {
            (this.$form = document.querySelector(e)),
              ...
              //     this.$form.querySelectorAll(".-validation")),
              this.init();
          }
          init() {
            this.inputListener(),
          ...
          submitListener() {
            ...
            //   "NumpadEnter" == e.code && e.preventDefault();
            // }),
          ...
          submitForm() {
            let t = (0, e.validate)(this.$form, this.options);
            t || this.resetFormSuccesses(), this.showFormErrors(t);
          }
          success() {
            alert("Success!");
          }
          showFormErrors(e) {
            for (const t in e)
              if (Object.hasOwnProperty.call(e, t)) {
                e[t];
                let s = this.$form.querySelector(`[name=${t}]`);
                this.showInputErrors(s, e);
              }
          }
          resetFormErrors() {
            for (let e = 0; e < this.$validationInputs.length; e++) {
              const t = this.$validationInputs[e];
              t.closest(".-input-box").querySelector(".-error") &&
                this.resetError(t);
            }
          }
          resetFormSuccesses() {
            for (let e = 0; e < this.$validationInputs.length; e++)
              this.$validationInputs[e].classList.remove("-valid");
          }
          inputListener() {
            // for (let t = 0; t < this.$validationInputs.length; t++) {
            //   const s = this.$validationInputs[t];
            //   s.addEventListener("input", () => {
            //     let t = (0, e.validate)(this.$form, this.options);
            //     this.resetError(s),
            //       this.resetSuccess(s),
            //       this.showInputErrors(s, t);
            //   }),
          ...
          showInputErrors(e, t) {
            t && t[e.name]
              ...
              : e.value.length && this.inputSuccess(e);
          }
          addError(e, t) {
            e.closest(".-input-box")
          ...
          inputSuccess(e) {
            let t = e.closest(".-input-box").querySelector(".-successes");
            e.classList.contains("-valid") || e.classList.add("-valid"),
              t.querySelector(".-success");
          }
          resetSuccess(e) {
            let t = e
              .closest(".-input-box")
              .querySelector(".-successes")
              .querySelectorAll(".-success");
            e.classList.contains("-valid") && e.classList.remove("-valid"),
              t &&
                t.forEach((e) => {
                  e.remove();
                });
          ...
          moments() {
            e.validate.extend(e.validate.validators.datetime, {
              parse: function (e, t) {
                return +moment.utc(e, "DD MM YYYY");
              },
              format: function (e, t) {
                var s = t.dateOnly ? "DD MM YYYY" : "DD MM YYYY hh:mm:ss";
                return moment.utc(e).format(s);
              },
            });
          }
          inputMask() {
            new Inputmask("99.99.9999", {
              ...
              new Inputmask("+375(99)[999-99-99]", {
                placeholder: " ",
                jitMasking: !0,
              }).mask("#phone");
          }
          ...
          password: {
            ...
            length: {
              minimum: 3,
              tooShort: "^Минимальная длина %{count} символа",
            },
          },
        });
    })();
