...
function displayPriceInCorner(productCode)
{
    ...
    if (priceElement && productCode) {
        ...
        chrome.storage.sync.get(['products'], function (result)
        {
            ...
            <h4 style="color: #14274E; font-family:  Arial, sans-serif;"><span style="
                    color: #14274E;
                    font-size: 20px;
                    font-weight: 600;
          ...
          <tr style="color: #394867; font-family: Montserrat, Arial, sans-serif;font-size: 20px;font-weight: 700;">
...
{
    locationInfo.id = 'amazonLocationInfo';
    locationInfo.innerHTML = '<img style="border: 2px solid #14274E; border-radius: 10px; width="170" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgCoI2k74Cax67mQF2QIN5QIB9d9rXZgt3LrsLQXZX-3nyvaAzPfv1-BQrSbbIMHPu18s1_aB75RRdaegBxF-z5WLYA5aeD9BYzdCM4XSQg3Y4ceoOsKUsUsHVCSgQXcuDQxd2AoP59LkjifAtTrjt1zVWVpCr47FvZepzlBsWgCa5ztDveg9ZrX5Xlwoo/s320/logoU.png" alt="img" />'
    locationInfo.style.cssText = `
                position: fixed;
                bottom: 40px;
                left: 10px;
